...
python -m src.tml_ingest --years 2025 2026 || echo WARNING: tml_ingest failed, continuing...
...
python -m src.wta_backfill --years 2025 2026 || echo WARNING: wta_backfill failed, continuing...
